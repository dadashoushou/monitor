...
1. 确认 `git status` 中没有 `config.json`、`sites.json`、`data/`、缓存目录或图谱产物
2. 确认文档中的示例值使用占位符，而不是本机路径或真实密钥
...
- 设计/数据流文档中的路径示例优先使用 `./data` 或 `<your-data-dir>`
